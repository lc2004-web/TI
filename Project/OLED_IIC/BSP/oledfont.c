/**
 * @file  oledfont.c
 * @brief OLED font data arrays (ASCII 8x16, 6x8, GB2312 Chinese 16x16)
 *
 ...
 * Left to right within a page, top to bottom across pages.
 * Each bit corresponds to one pixel.
 *
 * Coordinate system:
 * Top-left corner is (0, 0).
 * X axis goes right, range 0~127.
 * Y axis goes down, range 0~63.
 */

/* ========================================================================
 * ASCII 8x16 font: 95 characters (0x20~0x7E), 16 bytes each
 * ======================================================================== */
...
const uint8_t OLED_F8x16[][16] =
{
    ...
    0x00,0x00,0x80,0x60,0x30,0x00,0x00,0x00,// ; 27
...
/* ========================================================================
 * ASCII 6x8 font: 95 characters (0x20~0x7E), 6 bytes each
 * ======================================================================== */
...
/* ========================================================================
 * GB2312 Chinese 16x16 font
 * Add characters as needed below. Format:
 *   {"XX", {32 bytes of 16x16 bitmap data}},
 * The empty-index entry "" serves as the default placeholder.
 * ======================================================================== */
...
const ChineseCell_t OLED_CF16x16[] = {
    ...
    /* Add more characters above this line. Format:
     *   {"GB2312code",
     *   0x??,0x??, ... 16 bytes upper half ...,
     *   0x??,0x??, ... 16 bytes lower half ...},
     */

    /* Default placeholder when character not found (a box/pattern) */
    "",

...
/*************************** 硬件抽象层配置 ****************************/
// GPIO地址切换宏定义
#define Switch_Address_0(i) ((i)?(DL_GPIO_setPins(Gray_Address_PORT,Gray_Address_P0_PIN)) : (DL_GPIO_clearPins(Gray_Address_PORT,Gray_Address_P0_PIN)))// 地址位0控制

#define Switch_Address_1(i) ((i)?(DL_GPIO_setPins(Gray_Address_PORT,Gray_Address_P1_PIN)) : (DL_GPIO_clearPins(Gray_Address_PORT,Gray_Address_P1_PIN)))// 地址位1控制

#define Switch_Address_2(i) ((i)?(DL_GPIO_setPins(Gray_Address_PORT,Gray_Address_P2_PIN)) : (DL_GPIO_clearPins(Gray_Address_PORT,Gray_Address_P2_PIN)))// 地址位2控制
